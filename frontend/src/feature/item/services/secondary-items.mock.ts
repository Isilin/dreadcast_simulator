...
export const MOCK_SECONDARY_ITEMS: ItemResponseDto[] = [
  ...
  },
  {
    ...
    image: 'https://wiki.dreadcast.net/images/thumb/3/33/Bracelet.png/50px-Bracelet.png',
    tech: 0,
    integrity: 40,
    type: 'secondary',
  },
  {
    ...
    image: 'https://wiki.dreadcast.net/images/thumb/b/b8/Ceinture.png/50px-Ceinture.png',
    tech: 360,
    integrity: 50,
    type: 'secondary',
  },
  ...
  },
  {
    id: '406',
    name: 'Chaîne',
    image: 'https://wiki.dreadcast.net/images/thumb/5/5c/Chaine.png/50px-Chaine.png',
    tech: 300,
    integrity: 80,
    type: 'secondary',
    prerequisites: [
  ...
  },
  {
    id: '407',
    name: 'Cibleur',
    image: 'https://wiki.dreadcast.net/images/thumb/e/ea/Cibleur.png/50px-Cibleur.png',
    tech: 240,
    integrity: 30,
    type: 'secondary',
    effects: [
  ...
  },
  {
    ...
    image: 'https://wiki.dreadcast.net/images/thumb/a/a5/Collier_tech.png/50px-Collier_tech.png',
    tech: 330,
    integrity: 120,
    type: 'secondary',
    prerequisites: [
  ...
  },
  {
    ...
    image: 'https://wiki.dreadcast.net/images/thumb/9/99/Cravate.png/50px-Cravate.png',
    tech: 360,
    integrity: 60,
    type: 'secondary',
  },
  {
    id: '411',
    name: 'Déflecteur',
    image: 'https://wiki.dreadcast.net/images/thumb/3/3f/Deflecteur.png/50px-Deflecteur.png',
    tech: 250,
    integrity: 150,
    type: 'secondary',
    prerequisites: [
  ...
  },
  {
    id: '412',
    name: 'Epaulettes',
    image: 'https://wiki.dreadcast.net/images/thumb/a/af/Epaulettes.png/50px-Epaulettes.png',
    tech: 350,
    integrity: 100,
    type: 'secondary',
    effects: [
  ...
  },
  {
    id: '419',
    name: 'Cache-oeil',
    image: 'https://wiki.dreadcast.net/images/thumb/7/7f/Cache-oeil.png/50px-Cache-oeil.png',
    tech: 400,
    integrity: 60,
    type: 'secondary',
    effects: [
  ...
  },
  {
    ...
    image: 'https://wiki.dreadcast.net/images/thumb/1/13/Mitaines.png/50px-Mitaines.png',
    tech: 360,
    integrity: 50,
    type: 'secondary',
    effects: [
  ...
  },
  {
    id: '422',
    name: 'Nucléodeck',
    image: 'https://wiki.dreadcast.net/images/thumb/e/ec/Nucleodeck.png/50px-Nucleodeck.png',
    tech: 320,
    integrity: 60,
    type: 'secondary',
    prerequisites: [
  ...
  },
  {
    id: '423',
    name: 'Parapactum',
    image: 'https://wiki.dreadcast.net/images/thumb/f/f0/Parapactum.png/50px-Parapactum.png',
    tech: 320,
    integrity: 60,
    type: 'secondary',
    effects: [
  ...
  },
  {
    id: '425',
    name: 'Monocle',
    image: 'https://wiki.dreadcast.net/images/thumb/0/00/Monocle.png/100px-Monocle.png',
    tech: 240,
    integrity: 80,
    type: 'secondary',
    effects: [
  ...
  },
  {
    ...
    image: 'https://wiki.dreadcast.net/images/thumb/4/4d/HOVERBOARD262.png/150px-HOVERBOARD262.png',
    tech: 240,
    integrity: 60,
    type: 'secondary',
    effects: [
